...
namespace MonoInjectionTemplate
{
    ...
    partial class HackMain : MonoBehaviour
    {
        ...
        public void LogDebug(string message) {
            if (DebugLogger) Utilities.ConsoleBase.WriteLine(message);
        }
        ...
        void OnGUI()
        {
            if (raceCar) {
                ...
                winTuner = GUI.Window(0, winTuner, (int id) => { CarXHelper.TunerWindow(ref engineTune, ref desc, ref originalDesc, () => {setDefaultProperties();}, ref winTuner ); }, "CarX Advanced EngineeeeE Tuner!!!!!!"); 
